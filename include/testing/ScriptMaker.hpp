...
namespace ECE141 {
    ...
    public:
        ...
        ScriptMaker& backupTest(int aCount=1) {
            ...
            insertUsers(cmds,0,5);
            addBooksTable(cmds);
            int theBookCount=2+(rand() % 5);
            insertBooks(cmds,rand() % 6, theBookCount);

            cmds << "select * from Books;\n";
            cmds << "show tables;\n";
            cmds << "backup " << theDBName << ";\n";
            cmds << "drop database " << theDBName << ";\n";

            expected.clear().add({
                                         {Commands::createDB,1},     {Commands::useDB,0},
                                         {Commands::createTable,1},  {Commands::insert,5},
                                         {Commands::createTable,1},  {Commands::insert,theBookCount},
                                         {Commands::select,theBookCount},      {Commands::showTables,2},
                                         {Commands::backupDB,2},     {Commands::dropDB,0},
                                 });
        ...
        ScriptMaker& restoreTest(std::istream &aSource) {
            cmds << aSource.rdbuf();
            cmds << "show tables;\n";
            cmds << "select * from Books;\n";
            cmds << "drop database foo;\n";
            ...
            expected.clear().add({
                                         {Commands::createDB,1},     {Commands::useDB,0},
                                         {Commands::createTable,1},  {Commands::insert,1,'>'},
                                         {Commands::createTable,1},  {Commands::insert,1,'>'},
                                         {Commands::showTables,2},
                                         {Commands::select,1,'>'},   {Commands::dropDB,0},
                                 });
